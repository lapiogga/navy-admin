...
Plans:
- [ ] 03-01-PLAN.md (W1) -- 04_인증서발급신청체계 (신청/승인/등록대장 + 공통 재사용)
- [ ] 03-02-PLAN.md (W1) -- 05_행정규칙포탈체계 (현행규정/예규/지시문서 + 즐겨찾기)
- [ ] 03-03-PLAN.md (W1) -- 14_나의제언 (메인/제언확인/관리자 + 추천/신고/답변)
- [ ] 03-04-PLAN.md (W1) -- 11_연구자료종합관리체계 (메인/자료CRUD/자료실/관리자6탭)
- [ ] 03-05-PLAN.md (W1) -- 16_회의실예약관리체계 (예약신청/내예약/관리/회의실CRUD+시간대/장비/사진)
**UI hint**: yes
...
| 3. 저복잡도 서브시스템 5개 | 0/5 | Planning complete | - |
