...
| 2026-04-13 - | 2026-04-13 - | - | PPT v6/v6.1 개선 | v5→v6 landscape→portrait 변환, v6→v6.1 5장→4장/폰트/레인확장/표배치 | 완료 |
| 2026-04-14 - | 2026-04-14 - | - | PPT v7/v8 개선 + 배포 | v7 겹침방지/테두리검정, v8 제목줄 10pt 한줄/높이축소, .gitignore PPTX 제외 후 GitHub push | 완료 |
