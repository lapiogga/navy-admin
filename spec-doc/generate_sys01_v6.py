#!/usr/bin/env python3
"""
SYS01 초과근무관리체계 기능명세서 PPTX v6 (portrait)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
SH = Inches(10)
ML = Inches(0.4)       # 좌우 마진
CW = Inches(6.7)       # 콘텐츠 폭 = 7.5 - 0.4*2       # 콘텐츠 폭 = 10 - 0.4*2
...
def p1_concept(prs):
    ...
    y0 = Inches(0.82)
    LH = Inches(0.62)       # 레이어 높이
    GAP = Inches(0.08)        # 레이어 간격
...
def main():
    ...
    out_path = os.path.join(OUT, 'SYS01_초과근무관리체계_분석설계_v6.pptx')
    prs.save(out_path)
