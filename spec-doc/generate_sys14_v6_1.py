#!/usr/bin/env python3
"""
SYS14 나의 제언 기능명세서 PPTX v6.1 (portrait, 4페이지)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def p3_usecase(prs):
    ...
    _title(s, '유스케이스 다이어그램',
           '3개 액터 x 8개 유스케이스, 16개 단위 프로세스', 2)
...
def p5_flowchart(prs):
    s = _sl(prs)
    _title(s, '업무처리 플로우차트',
           '핵심 프로세스: 제언 작성 → 접수 → 답변 — 4개 레인, 12단계', 4)
...
def main():
    ...
    out_path = os.path.join(OUT, 'SYS14_나의제언_분석설계_v6.1.pptx')
    prs.save(out_path)
